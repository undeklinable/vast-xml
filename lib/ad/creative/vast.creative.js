...
const VastTrackingEvent = require('./components/vast.trackingEvent');
const VastMediaFile = require('./components/vast.mediaFile');
...
class Creative {
  ...
  attachMediaFile(url, settings = {}) {
    this._mediaFiles.push(new VastMediaFile(url, settings));
    return this;
  }

  attachTrackingEvent(type, url, offset) {
    this._trackingEvents.push(new VastTrackingEvent(type, url, offset));
    return this;
  }
