...
class CompanionAd {
  ...
  get adParameters() {
    return this._attributes.adParameters;
  }

  get altText() {
    return this._attributes.altText;
  }
  get companionClickThrough() {
    return this._attributes.companionClickThrough;
  }

  get companionClickTracking() {
    return this._attributes.companionClickTracking;
  }
