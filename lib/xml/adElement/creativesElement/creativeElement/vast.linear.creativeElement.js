...
class VastLinearCreativeElement extends BaseCreativeElement {
  ...
  insertCreativeTypeElement(creative) {
    ...
    if (creative.skipOffset) {
      creativeOpts[XML_CONSTANTS.skipOffset] = creative.skipOffset;
    }
...
module.exports = VastLinearCreativeElement;