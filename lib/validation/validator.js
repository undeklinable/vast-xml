...
const VAST_SCHEMAS = {
  VAST_30: libxmljs.parseXmlString(fs.readFileSync(__dirname + '/../schemas/vast3_draft.xsd').toString()),
  VAST_201: libxmljs.parseXmlString(fs.readFileSync(__dirname + '/../schemas/vast_2.0.1.xsd').toString())
};
...
const DAAST_SCHEMAS = {
  DAST_11: libxmljs.parseXmlString(fs.readFileSync(__dirname + '/../schemas/daast-1.1.xsd').toString())
};
